...
- Financial Industry: Online banking apps that allow the user to move funds, where techniques like code injection and instrumentation on compromised devices pose a risk. In this case, controls from MASVS-R can be used to impede tampering, raising the bar for malware authors.
